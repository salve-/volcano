...
%\section*{Moment Tensor Inversion: a short introduction}
%$\cdots$ I'd like to go a bit into detail about the techniques, but don't really know how much is required and where to get a good %overview from as I actually didn't work with it myself $\cdots$ 
